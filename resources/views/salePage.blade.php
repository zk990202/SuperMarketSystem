...
@section('content')
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">开始你的购买之旅吧 ！</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                        ...
                        <form method="post" action="{{ url('/sale') }}">
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" >购买数量</th>
                                </tr>
                                </thead>
                                <tbody>
                            ...
                            <div class="box-footer">
                                <button id="submitButton" type="submit" class="btn btn-primary">确认购买</button>
                            </div>
                        </form>
                    </div>
                </div>
